...
public class Circulo implements Comparable<Circulo>{
    ...
    public interface Mueve{
        public Vector2 transforma(Vector2 v);
    }
    public static void main(String[] args) {
        Circulo c = new Circulo(new Vector2(0,0),15);
        Circulo c1 = new Circulo(new Vector2(0,0),16);
        Circulo c2 = new Circulo(new Vector2(0,0),17);
        Circulo c3 = new Circulo(new Vector2(0,0),18);
        System.out.println(c);
        Mueve f = (Vector2 v)->{ return new Vector2(v.getX()+10,v.getY());};
        c.transform(f);
        System.out.println(c);
    }
    /**
    ...
    **/
    ...
    public void transform(Mueve f){
        this.centro = f.transforma(this.centro);
    }
